...
**Name of your app** is an android app that allows a userModel to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [ok] Improve the userModel interface and theme the app to feel "twitter branded"
...
* [ ] When a userModel leaves the compose view without publishing and there is existing text, prompt to save or delete the draft.  The draft can be resumed from the compose view.
...
Here's a walkthrough of implemented userModel stories:
