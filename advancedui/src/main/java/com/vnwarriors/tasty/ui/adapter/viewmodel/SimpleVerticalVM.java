 ...
 */
public class SimpleVerticalVM extends com.vnwarriors.tasty.ui.adapter.viewmodel.BaseVM {
    ...
    @Override
    public int getVMType(com.vnwarriors.tasty.ui.adapter.vmfactory.ViewTypeFactory vmTypeFactory) {
